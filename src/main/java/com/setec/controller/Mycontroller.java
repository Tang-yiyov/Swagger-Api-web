...
//	http://localhost:8080/swagger-ui/index.html
	...
	public Object getById(@PathVariable("id")Integer id) {
		...
		if(pro.isPresent()) {
			...
			return ResponseEntity.status(404).body(Map.of("massage","product id = "+id+" not found"));
		}
	}
	...
	public Object getByName (@PathVariable("name") String name) {
		...
		if(pros.size()==0) {
			return ResponseEntity.status(404).body(Map.of("massage","product name = "+name+" not found"));
		}else {
			return pros;
		}
